...
job_id, date, c_time, mode, sim_id = in_arr[1:]
print("Running {} simulation".format(mode))
output_path = os.getcwd() + '/output_data/' + date + '-' + mode + sim_id # saving data path
...
if mode == "HPC":
    ...
    rhos = np.arange(0.001, 0.005, 0.001)  # Tree density range
