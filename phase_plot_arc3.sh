...
# Ensemble size | number of simulation repeats
...
python3 mkdir.py $date_time $ensemble_size $data_type $sim_name
######### find epidemiological phase space diagram #########
python3 main_phase.py  $SGE_TASK_ID $date_time $ensemble_size $data_type $sim_name
...
python3 mkdir.py  $date_time $ensemble_size $data_type $sim_name
######### find epidemiological phase space diagram #########
python3 main_phase.py  $job_id $date_time $ensemble_size $data_type $sim_name
