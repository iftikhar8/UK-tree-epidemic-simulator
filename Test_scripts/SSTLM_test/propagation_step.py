...
def t_step(infected, susceptible, sigma, beta, test_cell):
    ...
    blurred_field = beta * pre_factor * gaussian_filter(pot_infect_field, sigma=[0, sigma, sigma], truncate=3.0)
    # Calculate transition probabilities via Pr(S-->I) = 1 - RP{1 - P_ij}
