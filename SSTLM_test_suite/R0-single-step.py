...
"""
This code works out the number of infected individuals over a single initial time-step t=0-->t=1.
Imported models the t_step module which simulates a single step in S-->I-->R.
"""

def R0_phase():
    """
    Work out the rho vs beta --> R_0:
    From this we generate a phase-space diagram for the number of secondary infected cells from the primary infectious
    tree. We save data.
    :return: None
    """
    L = 200  # lattice size
...
def R0_v_ell():
    """
    We work out the basic reproduction number over a single time-step as a function for dispersal distance and density.
    We find that there is no variation in R_0 as a function of distance.
    :return:
    """
    L = 200
    rho = .25
