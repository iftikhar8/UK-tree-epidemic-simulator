...
params = {"T": 200, "epi_c": [690, 700, 550, 560], "plt_epi": False, "partial": [True,  [800, 900, 300, 400]],
          'L': L_index, 'R0': R0_space[int(r0_index)], "modified": True}
...
diffusion_map = np.ones(shape=diffusion_map.shape) * 0.50
growth_map = np.ones(shape=diffusion_map.shape) * 1.0
maps_ = np.zeros(shape=(2, growth_map.shape[0], growth_map.shape[1]))
maps_[0], maps_[1] = diffusion_map, growth_map
